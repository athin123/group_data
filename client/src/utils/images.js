...
import iconmain from "../components/img.jpg"

export const iconsImgs = {
    alert, bell, bills, budget, card, iconmain, check, empty_check, gears, home, menu, plane, plus, report, search, user, wallet, wealth
}
